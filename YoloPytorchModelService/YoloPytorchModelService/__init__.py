...
__VERSION__ = "20211214061319_C31782"

__module_path = os.path.abspath(os.path.dirname(__file__))

YoloPytorchModelService = saved_bundle.load_bento_service_class(__module_path)
...
__all__ = ['__version__', 'YoloPytorchModelService', 'load']
